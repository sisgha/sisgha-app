  ...
  <div class="modal-overlay">
    <form class="modal">
      <div class="img_container">
        <h4 class="title">Cadastrar nova turma</h4>
        <div class="contemimg">
          <img class="ft" src="~/assets/Foto.png">
              <div class="search-bar1">
        <fieldset class="f1">
          <legend class="legenda1">Série</legend>
          <p class="placeholder1">1°A</p>
        </fieldset>
      </div>
      <div class="search-bar2">
        <fieldset class="f2">
          <legend class="legenda2">Modalidade</legend>
          <p class="placeholder2">Técnico Integrado</p>
        </fieldset>
      </div>
      <div class="search-bar3">
        <fieldset class="f3">
          <legend class="legenda3">Curso</legend>
          <p class="placeholder3">Técnico em Informática</p>
        </fieldset>
      </div>
      <div class="grupX">
